...
export function HomePage() {
  ...
  useEffect(() => {
    ...
    events.length,
    session.data?.recommendations.length,
    session.data?.prompts?.length,
  ]);
  ...
  const errorMessage =
    status === "error"
      ? (session.data?.error_message ?? "Something went wrong.")
      : undefined;
        ...
        {!hasContent && !showLibraryLoading && (
          <div className={css.empty}>
            <p className={css.emptyText}>
              Tell me what you're in the mood for. I'll comb through your Plex
            ...
            <LinearProgress
              sx={{
                ...
                "& .MuiLinearProgress-bar": {
                  backgroundColor: "var(--lobby-accent)",
                },
              }}
            />
          </div>
